...
This is a fork with some improvements of the [MDAKM Lab](https://mdakm.ceid.upatras.gr/) RWR_MH algorithm in the framework of my thesis in patient classification for patients with hypercholesterolemia and diabetes.
...
All functions for modular reproducibility for unweighted, weighted, Top-K and Elasticnet
Supra-adjacency matrices as well as the vectorised and original multiplex transition matrix creation can be found in [All_Functions.R](https://github.com/Feasao/RWRLab/blob/main/Random_walk/Functions/All_Functions.R)
